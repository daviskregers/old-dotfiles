...
pulseaudio-alsa pavucontrol ctags xcompmgr libreoffice aws-cli wireshark-qt jdk-openjdk
...
vim-youcompleteme-git compton-conf shantz-xwinwrap-bzr pgadmin3
